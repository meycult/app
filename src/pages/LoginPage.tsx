      ...
      <div className="relative z-10 w-full max-w-md px-4">
        <div className="glass rounded-xl p-8 glow-accent">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg border border-line/50 bg-white/5 hover:bg-white/10 transition-colors text-sm font-medium"
          >
